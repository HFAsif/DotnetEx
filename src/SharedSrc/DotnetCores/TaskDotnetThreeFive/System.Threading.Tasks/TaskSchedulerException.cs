...
public class TaskSchedulerException : Exception
{
	...
	public TaskSchedulerException()
		: base(Environment2.GetResourceString("TaskSchedulerException_ctor_DefaultMessage"))
	{
	}
	...
	public TaskSchedulerException(Exception innerException)
		: base(Environment2.GetResourceString("TaskSchedulerException_ctor_DefaultMessage"), innerException)
	{
	}
