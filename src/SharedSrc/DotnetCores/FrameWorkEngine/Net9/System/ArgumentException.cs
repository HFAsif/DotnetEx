...
namespace System
{
    ...
    public class ArgumentException : SystemException
    {
        ...
        public ArgumentException()
            : base(SR3.Arg_ArgumentException)
        {
        ...
        {
            if (HelperViews.IsNullOrWhiteSpace(argument))
            {
        ...
        private static void ThrowNullOrEmptyException(string? argument, string? paramName)
        {
            ...
            throw new ArgumentException(SR3.Argument_EmptyString, paramName);
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(argument, paramName);
            throw new ArgumentException(SR3.Argument_EmptyOrWhiteSpaceString, paramName);
        }
    }
}
