...
internal static class Win32Native
{
    ...
    internal struct WIN32_FIND_DATA
    {
        ...
        internal bool IsNormalDirectory
        {
            get
            {
                if (((uint)dwFileAttributes & 0x10u) != 0)
                {
    ...
    internal static int SetErrorMode(int newMode)
    {
        ...
        {
            SetErrorMode_Win7AndNewer(newMode, out var oldMode);
            return oldMode;
        }
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    internal static extern bool DuplicateTokenEx([In] SafeAccessTokenHandle ExistingTokenHandle, [In] TokenAccessLevels DesiredAccess, [In] IntPtr TokenAttributes, [In] SECURITY_IMPERSONATION_LEVEL ImpersonationLevel, [In] TokenType TokenType, [In][Out] ref SafeAccessTokenHandle DuplicateTokenHandle);
