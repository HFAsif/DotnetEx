...
{
    public static bool IsMomentumError(this Exception error)
    {
    ...
    public static bool HasTypeOf(this Exception exp, params Type[] types)
    {
    ...
    public static bool HasSource(this Exception exp, params string[] sources)
    {
        Exception innerException = exp;
        while (innerException != null)
        {
